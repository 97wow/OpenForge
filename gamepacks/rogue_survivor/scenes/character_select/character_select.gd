...
func _create_class_card(cls: Dictionary) -> PanelContainer:
	...
	name_label.text = I18n.t(cls["name_key"])
	...
	attr_label.text = "[ %s ]" % I18n.t(cls["icon_key"])
	...
	stats_label.text = I18n.t(cls["stats_key"])
	...
	desc_label.text = I18n.t(cls["desc_key"])
	...
	# 选择按钮
	var btn := Button.new()
	btn.text = I18n.t("SELECT_CLASS", [I18n.t(cls["name_key"])])
